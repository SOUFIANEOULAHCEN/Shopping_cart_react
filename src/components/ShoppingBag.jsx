    ...
    show && (
      <div className="w-[50%] absolute right-0 h-auto px-[10%] py-[5%] shadow-lg">
        <div className="flex justify-between">
          ...
          <button
            className="font-bold hover:text-xl transition-all duration-300"
            onClick={
              HandleShow
            }
          >
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="flex justify-between pr-4">
                  <div className="flex gap-1">
                    <button className="text-gray-900 hover:text-gray-100 px-3 py-1 rounded-md hover:bg-gray-700 transition-all ease-in duration-300 shadow-md">
                      +
                    </button>
        ...
        <div className="w-full px-6 py-3 bg-gray-800 text-gray-100 mt-2 text-center text-xl ">
          Check out
        </div>
      </div>
    )
